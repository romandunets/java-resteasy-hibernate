...
CREATE TABLE IF NOT EXISTS `connections` (
  ...
  `connection_type_id` BIGINT(20) NOT NULL,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `fk_connections_to_connection_types` FOREIGN KEY (`connection_type_id`) REFERENCES `connection_types` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
);
